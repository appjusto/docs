...
A natureza da relação jurídica entre você e seus colaboradores com appjusto, com entregadores e consumidor é de natureza cível e não existe nenhuma relação trabalhista entre quaisquer dos agentes citados.. Se você não acredita nisso, por favor não aceite esses termos.
  ...
  1. **Condições para fazer parte.**
    1. Pré-requisitos.

Para você fazer poder operar na nossa plataforma é necessário que você preencha os pré-requisitos abaixo:

1. Aceitar os presentes termos e nossa política de privacidade;
2. Possuir CNPJ ativo em CNAE adequado para comércio de alimentos preparados. Você não precisa ser uma sociedade empresária. Você pode ser inclusive um MEI (Micro Empreendedor Individual) com o CNAE adequado.
3. Ser titular de conta bancária válida.
4. Possuir a infraestrutura necessária para receber os pedidos (computador, internet, etc.)
...
- Definir endereço do restaurante, raio de entrega e tempo médio de preparo dos pratos
    ...
    1. Podemos também a qualquer tempo solicitar novas informações ou documentos ou mesmo exigir que você preencha outros pré-requisitos para continuar com a gente.
    2. Responsabilidades.
...
1. Manter as informações inseridas na plataforma sempre atualizadas, respondendo pela veracidade das mesmas, bem como honrar os preços e promoções publicadas.
2. Praticar preços inferiores a outros Apps e sempre que possível os mesmos preços do cardápio da loja física.
3. Auxiliar o AppJusto na melhoria da plataforma, seja nos informando sempre que identifique algum defeito que provoque o mau funcionamento da plataforma, seja com o envio de sugestões de melhoria.
4. Treinar a sua equipe para que ela possa operar a plataforma corretamente e utilizar todas as funcionalidades da plataforma
5. Manter o restaurante aberto no horário definido, aceitar e executar os pedidos.
6. Manter a descrição de cada item disponível (produtos) sempre atualizadas, de forma que o cliente possa identificar com facilidade as características do seu produto.
7. Ter o compromisso de fazer o suporte aos clientes em primeira instância em relação aos pedidos (ex: divergência e/ou qualidade entre o pedido e o produto entregue)
8. Entender a importância de ajudar na divulgação do AppJusto para outros restaurantes e atração de consumidores para que este movimento ganhe corpo e se consolide como uma alternativa para equilíbrio no mercado de delivery.

    1. Suspensão e banimento.
...
1. CADASTRO – AUTORIZAÇÃO PARA TRATAMENTO DE DADOS
...
- Realizar o tratamento dos seus dados, envolvendo operações a coleta, produção, recepção, classificação, utilização, acesso, reprodução, transmissão, distribuição, processamento, arquivamento, armazenamento, eliminação, avaliação ou controle da informação, modificação, comunicação, transferência, difusão ou extração conforme as finalidades especificadas neste documento.
  ...
  1. Atualização, cancelamento e exclusão.
...
A AppJusto responsabiliza-se pela manutenção de medidas de segurança, técnicas e administrativas aptas a proteger os dados pessoais de acessos não autorizados e de situações acidentais ou ilícitas de destruição, perda, alteração, comunicação ou qualquer forma de tratamento inadequado ou ilícito. Qualquer incidente de segurança que possa acarretar risco ou dano relevante ao Titular deverá ser comunicado ao titular e à Autoridade Nacional de Proteção de Dados (ANPD) em conformidade ao art. 48 da Lei nº 13.709/2018.
  ...
  1. Término do Tratamento dos Dados
